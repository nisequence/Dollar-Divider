...
export default function DeleteOwnProfile(props) {
  ...
  const deleteProfile = async () => {
    ...
    try {
     ...
     // If the server does not provide a failure message
      if (data.message === "User was successfully removed from the household and deleted!") {
  ...
  return (
    <>
      <Button className='bg-danger' onClick={deleteProfileConfirmation}>Delete Profile</Button>
    </>
  )
}
